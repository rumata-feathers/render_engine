...
class MainWindow : public QMainWindow, protected QOpenGLFunctions {
 ...
 private slots:
  ...
  void on_actionSave_triggered(int i = 0);
...
//
//  void draw(int* sample = new int(), QTimer* q_timer = new QTimer, std::pair<int, int> start = {0, 0},
...
// public:
// signals:
//  Q_SIGNAL void FinishedRendering();
// private:
//  int* current_frame = new int(61);
//  int end_frame = 0;
//
